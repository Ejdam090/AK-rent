  ...
  return (
    <>
      <div className="flex gap-2">
        <input
          type="text"
          placeholder={"Dodaj zdjęcie przy użyciu linku  .jpg"}
          value={photoLink}
      ...
      <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
        ...
        <label className="border h-32  cursor-pointer items-center flex justify-center gap-1  bg-transparent rounded-2xl p-2  text-gray-600">
